sap.ui.define([
		...
		return BaseObject.extend("zetms.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias zetms.model.ListSelector
			 */
			 ...
			 * @return {zetms.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
