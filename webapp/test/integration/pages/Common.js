sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zetms/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("zetms.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zetms/localService/mockserver"], function (mockserver) {
